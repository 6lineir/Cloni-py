...
class User(AbstractUser):
    ...
    phone = models.CharField(max_length = 16, verbose_name='موبایل', blank=True)
    codeMelli = models.CharField(max_length = 10, unique=True, verbose_name='کد ملی', blank=True, null=True)
